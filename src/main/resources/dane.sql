...
insert into test (czas_trwania, data_uruchomienia, data_zakonczenia, nazwa, token, nauczyciel_id) values ('2022-09-14 00:30:00', '2022-09-14', '2022-09-16', 'test1', 'token', 1);
insert into test (czas_trwania, data_uruchomienia, data_zakonczenia, nazwa, token, nauczyciel_id) values ('2022-09-14 00:30:00', '2022-09-14', '2022-09-16', 'test2', 'token2', 1);
...
insert into pytanie (pytanie_id, tresc, test_id) values (3, 'ile masz lat?', '2');
insert into pytanie (pytanie_id, tresc, test_id) values (4, 'ile masz wzrostu?', '2');
...
insert into odpowiedz (czy_poprawna, tresc, pytanie_id) values (true, '4', 2);
insert into odpowiedz (czy_poprawna, tresc, pytanie_id) values (false, '5', 2);
...
insert into odpowiedz (czy_poprawna, tresc, pytanie_id) values (true, '4', 3);
insert into odpowiedz (czy_poprawna, tresc, pytanie_id) values (false, '5', 3);
insert into odpowiedz (czy_poprawna, tresc, pytanie_id) values (false, '6', 3);
